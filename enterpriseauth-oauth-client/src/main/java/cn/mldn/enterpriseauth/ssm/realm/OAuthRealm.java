...
import cn.mldn.enterpriseauth.ssm.filter.token.OAuthToken;
public class OAuthRealm extends AuthorizingRealm {
	@Resource 
	private IMemberAuthorService memberAuthorService ; 
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		Map<String,Set<String>> map = this.memberAuthorService.getRoleAndActionByMember(mid) ;
